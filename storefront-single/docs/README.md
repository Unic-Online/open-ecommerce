...
- [`../AGENTS.md`](../AGENTS.md) — primary technical reference: stack, file map,
  the config file, how-to guides (rebrand / add product / add category /
  theme / feature flags), env vars, storage/Mongo schema, conventions,
...
- `../src/site.config.ts` — brand, the market, categories, storage, features.
- `../src/content/strings.ts` — UI strings (typed namespaces, English).
