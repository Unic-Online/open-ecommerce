...
// Runs on `/checkout` — the single `main` market allows both payment methods
// and prices in EUR, matching SAMPLE_CART_ITEM's currency (CartProvider's
// price guard would otherwise drop the seeded item).
