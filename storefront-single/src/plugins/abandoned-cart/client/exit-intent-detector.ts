...
interface DetectorOptions {
  ...
  onTrigger: () => void;
  // Trigger 3: intercept the first mobile back press with the popup.
  // Off by default — it costs the user one extra back press, so it ships
  // behind NEXT_PUBLIC_ABANDONED_CART_BACK_INTERCEPT as an experiment.
