...
const c: Copy = {
  subject: `Sign in to your ${MARKET.name} account`,
  preheader: 'Tap the link to access your account. The link is valid for 15 minutes.',
  heading: 'Access your account',
  body: `Tap the button below to sign in to your ${MARKET.name} account and view your orders.`,
  cta: 'Open my account',
  ...
  footer: `${MARKET.name} — ${MARKET.domain}`,
};
