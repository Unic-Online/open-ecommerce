...
export function renderContactEmail(params: ContactEmailParams): string {
  const { firstName, lastName, email, phone, subject, message } = params
  ...
  <body style="margin: 0; padding: 0; background: #040810; color: #e8ecf2; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;">
    <div style="max-width: 600px; margin: 0 auto; padding: 32px 20px;">
      ...
      <div style="text-align: center; margin-bottom: 32px;">
        ...
        <p style="color: #8892a6; font-size: 14px; margin: 8px 0 0;">New message from the contact form</p>
      </div>

      <div style="background: #0d1117; border: 1px solid #1a1f2e; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
        <h2 style="font-size: 16px; margin: 0 0 16px; color: #e8ecf2;">📬 Subject</h2>
        <p style="margin: 0; color: #00E5CC; font-size: 18px; font-weight: 600;">${escapeHtml(subject)}</p>
      </div>

      <div style="background: #0d1117; border: 1px solid #1a1f2e; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
        <h2 style="font-size: 16px; margin: 0 0 16px; color: #e8ecf2;">👤 Contact details</h2>
        <table style="font-size: 14px; color: #b0b8c8;" cellpadding="4" cellspacing="0">
          <tr><td style="color: #8892a6; padding-right: 12px;">Name:</td><td><strong style="color: #e8ecf2;">${escapeHtml(firstName)} ${escapeHtml(lastName)}</strong></td></tr>
          ...
          <tr><td style="color: #8892a6; padding-right: 12px;">Phone:</td><td><a href="tel:${escapeHtml(phone)}" style="color: #00E5CC;">${escapeHtml(phone)}</a></td></tr>
        </table>
      </div>

      <div style="background: #0d1117; border: 1px solid #1a1f2e; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
        <h2 style="font-size: 16px; margin: 0 0 16px; color: #e8ecf2;">💬 Message</h2>
