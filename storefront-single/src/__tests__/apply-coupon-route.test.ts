/**
 * POST /api/cart/apply-coupon: bot guard, schema validation, dry-run, and
 * every validateCoupon outcome — unknown / already-used / expired /
 * wrong-email / valid — through the real coupons lib against the shared Mongo
 * mock. Coupon codes carry the template's `SHOP` prefix (commerce.couponPrefix).
 */
