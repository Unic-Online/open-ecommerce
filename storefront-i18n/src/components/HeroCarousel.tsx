...
const SLIDE_META: SlideMeta[] = [
  ...
  // Category pathnames are generated from the registry, so cast to AppPathname.
  { image: '/images/halo-table-lamp/3.jpg', href: '/lighting' as AppPathname },
  { image: '/images/terra-path-light/3.jpg', href: '/outdoor' as AppPathname },
  { image: '/images/aria-console/3.jpg', href: '/furniture' as AppPathname },
]
