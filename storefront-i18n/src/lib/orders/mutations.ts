 ...
 *   - `markReviewEmailSent`/`markReviewEmailFailed` mirror the shipment-email
 *     pair exactly, for the post-delivery review-request cron
 *     (`@/lib/orders/review-request-cron`) — the eligibility query there reads
 *     `fulfillment.reviewEmailSentAt`, not this module.
