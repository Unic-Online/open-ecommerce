/**
 * POST /api/capture-email (issue #19) — validation and contact-upsert
 * contracts. The defensive empty/truncated-body behavior is pinned
 * separately in `capture-email-empty-body.test.ts`; this file covers the
 * rest of the surface.
 */
